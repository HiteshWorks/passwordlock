  ...
  return (
    <>
      ...
      <div className="container h-screen w-full flex justify-center bg-[url('/images/bg.jpg')] bg-cover bg-center">
        <div className="flex-col gap-2 h-48 sm:mx-0 md:mx-0  ">
          <div
            className={`heading sm:text-6xl sm:left-12 lg:text-9xl md:left-24 text-stone-800   shadow-sm shadow-pink-200 lg:left-96 absolute top-0`}
          >
            Tic Tac Toe
          </div>
          ...
          <div className="navbar w-[40vw] bg-pink-400 absolute top-[80%] mx-[-5%] mt-12 flex gap-44 text-4xl border-4 border-yellow-300 shadow-lg shadow-gray-400 rounded-full">
            <div
              title="restart"
              onClick={handlerestart}
              className="cursor-pointer text-white shadow-md bg-black shadow-yellow-200 absolute rounded-lg left-0"
            >
              <MdRestartAlt />
            </div>
            <div
              onClick={WhosGo}
              className={`whogo text-4xl cursor-pointer absolute left-[35%] bg-black rounded-lg ${
                arrayIndex % 2 === 0
                  ? `text-red-400`
                  : result
                  ? `text-pink-300`
            ...
            <div
              ...
              className="text-white absolute right-0 cursor-pointer bg-black rounded-lg "
            >
        ...
        <div className="flex justify-between absolute mt-5 gap-[20vw] p-1  top-[90%] ">
